...
const ORDER_DETAIL_FIELDS =
  "+email,+customer_id,+items,+items.variant,+items.adjustments,*customer,+shipping_address,+billing_address,*shipping_methods,+shipping_methods.adjustments,+promotions.*,+metadata,+fulfillments,+fulfillments.items,+fulfillments.labels,+payment_collections,+payment_collections.payments,+region,+sales_channel"
