    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-card p-6 shadow-sm space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Manage your admin team. Invite new members to grant access to the dashboard.
        </p>
      ...
      <Dialog open={showInvite} onOpenChange={setShowInvite}>
        <DialogContent onClose={() => setShowInvite(false)}>
          ...
          <div className="space-y-4 py-4">
            <p className="text-sm text-muted-foreground">
              Send an invitation email to a new team member. They will be able to
              access the admin dashboard after accepting.
            </p>
