          ...
          <div className="relative h-[400px] lg:h-[450px]">
            ...
            <div className="absolute inset-0 flex items-center">
              <div className="max-w-lg px-8 lg:px-12">
                ...
                <h2 className="text-2xl md:text-3xl font-serif font-bold text-white leading-tight text-balance">
                  品鑑古巴的靈魂
                </h2>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm border border-white/30 text-white hover:border-white/60 transition-colors tracking-wide"
                  >
                    入門選購指南
                  </Link>
                </div>
