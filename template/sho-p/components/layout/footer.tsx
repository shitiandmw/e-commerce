...
const footerLinks = {
  about: {
    ...
    links: [
      ...
      { label: "門店資訊", href: "/stores" },
    ],
  },
  membership: {
    title: "會員專屬",
    links: [
      { label: "會員優惠", href: "/membership" },
      { label: "積分計劃", href: "/rewards" },
      { label: "推薦好友", href: "/referral" },
    ],
  },
  service: {
    title: "客戶服務",
    links: [
      ...
      { label: "常見問題", href: "/faq" },
      { label: "私隱條款", href: "/privacy" },
    ],
  },
  content: {
    title: "茄時分享",
    links: [
      { label: "雪茄快訊", href: "/articles" },
      { label: "品鑑指南", href: "/articles" },
      { label: "品味生活", href: "/articles" },
    ],
  },
}
