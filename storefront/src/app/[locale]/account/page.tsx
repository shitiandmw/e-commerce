  ...
  return (
    <div>
      ...
      <div className="mb-8 rounded-lg border border-border bg-surface p-6">
        ...
        <Link href={`/${locale}/account/profile`} className="mt-4 inline-block text-sm text-gold hover:text-gold-light">
          编辑资料 →
        </Link>
      </div>
      ...
      <div className="rounded-lg border border-border bg-surface p-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Link href={`/${locale}/account/orders`} className="text-sm text-gold hover:text-gold-light">
            查看全部 →
          </Link>
        </div>
        {loadingOrders ? (
