        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            ...
            <tr>
              ...
              {items.map((product) => (
                <td key={product.id} className="border-b border-border p-3 text-center">
                  <Link href={`/${locale}/products/${product.handle}`} className="inline-block">
            ...
            <tr>
              ...
              {items.map((product) => (
                <td key={product.id} className="border-b border-border p-3 text-center">
                  <Link href={`/${locale}/products/${product.handle}`} className="text-sm font-medium text-foreground hover:text-gold transition-colors">
                    {product.title}
                  </Link>
                </td>
              ))}
          ...
          return (
            <div key={product.id} className="w-64 shrink-0 rounded-lg border border-border bg-surface p-4">
              <div className="mb-3 flex items-start justify-between">
                <Link href={`/${locale}/products/${product.handle}`} className="relative h-24 w-24 shrink-0 overflow-hidden rounded bg-surface-light">
                  {product.thumbnail ? (
